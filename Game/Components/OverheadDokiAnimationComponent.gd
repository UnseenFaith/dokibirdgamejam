...
class_name OverheadDokiAnimationComponent
extends Component
...
@export var fireAnimation: StringName = &"shooting"
...
func _process(_delta: float) -> void:
	...
	var didFire = inputComponent.inputActionsPressed.has(GlobalInput.Actions.fire)
	
	if not fireAnimation.is_empty() \
	and didFire:
		animationToPlay = fireAnimation
	else:
		animationToPlay = "default"
